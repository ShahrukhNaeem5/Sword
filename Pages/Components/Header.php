        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <div class="logo-container order-1 order-lg-2 text-center">
                    <img src="<?php echo htmlspecialchars($base_url . '/' . ltrim($currentLogo, './')); ?>" srcset="<?php echo htmlspecialchars($base_url . '/' . ltrim($desktopLogo, './')); ?> 1200w,
                             <?php echo htmlspecialchars($base_url . '/' . ltrim($mobileLogo, './')); ?> 600w"
                ...
                <div class="user-actions order-3 order-lg-3">
                    <?php foreach ($menuItems as $item): ?>
                        ...
                        if (stripos($item['menu_name'], 'sign') !== false || stripos($item['menu_name'], 'login') !== false) {
                            $iconClass = 'bi-box-arrow-in-right';
                        } elseif (stripos($item['menu_name'], 'cart') !== false || stripos($item['menu_name'], 'basket') !== false) {
                            ...
                            if ($cart_count > 0) {
                                $badge = '<span class="cart-badge" id="cart-count">' . $cart_count . '</span>';
                            } else {
                                $badge = '<span class="cart-badge" id="cart-count" style="display:none;">0</span>';
                            }
                        }
                        ?>

                        <a href="<?= htmlspecialchars($item['menu_link']) ?>" class="position-relative">
